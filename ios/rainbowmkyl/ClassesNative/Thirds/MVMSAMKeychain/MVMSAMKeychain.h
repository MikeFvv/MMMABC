...
/**
 ...
 platform.
 */
typedef NS_ENUM(OSStatus, MVMSAMKeychainErrorCode) {
	/** Some of the arguments were invalid. */
	MVMSAMKeychainErrorBadArguments = -1001,
};

/** SAMKeychain error domain */
extern NSString *const kMVMSAMKeychainErrorDomain;

/** Account name. */
extern NSString *const kMVMSAMKeychainAccountKey;
 ...
 */
extern NSString *const kMVMSAMKeychainCreatedAtKey;

/** Item class. */
extern NSString *const kMVMSAMKeychainClassKey;

/** Item description. */
extern NSString *const kMVMSAMKeychainDescriptionKey;

/** Item label. */
extern NSString *const kMVMSAMKeychainLabelKey;

/** Time the item was last modified.

 The value will be a string.
 */
extern NSString *const kMVMSAMKeychainLastModifiedKey;

/** Where the item was created. */
extern NSString *const kMVMSAMKeychainWhereKey;
 ...
 */
@interface MVMSAMKeychain : NSObject

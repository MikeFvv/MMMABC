...
NS_ASSUME_NONNULL_BEGIN
	...
	#define MVMSAMKEYCHAIN_SYNCHRONIZATION_AVAILABLE 1
#endif

#if __IPHONE_3_0 || __MAC_10_9
	// Keychain access group available at compile time
	#define MVMSAMKEYCHAIN_ACCESS_GROUP_AVAILABLE 1
#endif

#ifdef MVMSAMKEYCHAIN_SYNCHRONIZATION_AVAILABLE
typedef NS_ENUM(NSUInteger, MVMSAMKeychainQuerySynchronizationMode) {
	MVMSAMKeychainQuerySynchronizationModeAny,
	MVMSAMKeychainQuerySynchronizationModeNo,
	MVMSAMKeychainQuerySynchronizationModeYes
};
#endif
 ...
 */
@interface MVMSAMKeychainQuery : NSObject
...
@property (nonatomic) MVMSAMKeychainQuerySynchronizationMode synchronizationMode;
#endif
...
/**
 ...
 MVMSAMKEYCHAIN_SYNCHRONIZATION_AVAILABLE is only for compile time. If you are checking for the presence of synchronization,

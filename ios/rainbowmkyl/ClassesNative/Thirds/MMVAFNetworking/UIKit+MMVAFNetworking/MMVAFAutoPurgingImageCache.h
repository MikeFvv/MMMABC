...
/**
 The `MMVAFImageCache` protocol defines a set of APIs for adding, removing and fetching images from a cache synchronously.
 */
@protocol MMVAFImageCache <NSObject>
 ...
 */
@protocol MMVAFImageRequestCache <MMVAFImageCache>
 ...
 */
@interface MMVAFAutoPurgingImageCache : NSObject <MMVAFImageRequestCache>
